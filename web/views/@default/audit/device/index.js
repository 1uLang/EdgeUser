Tea.context(function () {
    ...
    this.onSearch = function () {
        this.$get(".").params({
            ...
            if (resp.code === 200) {
                if (resp.data.deviceList)
                    this.deviceList = resp.data.deviceList
                else
                    this.deviceList = []
    ...
    this.onDelete = function (id) {
        teaweb.confirm("确定要删除该设备？", function () {
            this.$post("/audit/device/delete").params({
                Opt: "delete",
                id: id,
            }).refresh()
        })
